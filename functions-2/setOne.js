...
let oneLineFunction = (param1, param2) => console.log(`the first parameter is ${param1}. the second parameter is ${param2}.`)


oneLineFunction('String', true)
...
greeting('Katryna', 'Yaworski', callBack = (fullName) => console.log(`Hello, my full name is ${fullName}`))
...
pricesPlusTax(prices, callBack = (totalCost) => console.log(`The new array plus tax = ${totalCost}`))
...
function multiplyingFactory(number1){
    return function multiplyByFive(number2){
        if(number1 >= 5){
            console.log(number1 * number2)
        }else {
            console.log(`Cannot multiply: the first is smaller than 5`)
        }
    }
}
/* 
